...
# from DRLR_class import SimSet1,DistributionallyRobustLG,coreset_lr,Logistic_regression,Coreset_lr,coreset_lr2
    ...
    for epsilon_range in Epsilon_range:
        for sample_size_index in Sample_size_index:
            ...
            if not os.path.exists(path):
                os.makedirs(path)
            path_res = 'letter_a_r_{}_xsigma_{}_y_sigma{}_samp_{}.mat'.format(
                epsilon_range,
            ...
            for c1 in range(1):
                for c2 in range(1):
                    ...
                    cc2 = class2[c2]
                    print('################################', cc1, cc2, '#####################################')
                    X_tr, y_tr, X_ts, y_ts = load_letter_alfa()
                    d = X_tr.shape[1]
